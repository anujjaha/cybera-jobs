...
public function edit($job_id=null)
{
      ...
      $jobdata['print_invoice']     = $this->input->post('print_invoice') ? $this->input->post('print_invoice') : 0;
			...
			$jobdata['is_customer_waiting'] = $this->input->post('is_customer_waiting');
                ...
                $isPorter = $this->input->post('cyb_porter') ? $this->input->post('cyb_porter') : 0;
                
                if($isPorter == 1)
                {
                  //Add porter details
                  $jobdata['cyb_porter']            = 1;
                  $jobdata['cyb_porter_pay']        = $this->input->post('cyb_porter_pay');
    ...
    if($job_id) 
      ...
      //pr($data['reference_data']);
        ...
        {
          $jobdata['cyb_porter']            = 0;
          $jobdata['cyb_porter_pay']        = '';
          $jobdata['cyb_porter_details']    = '';
          $jobdata['cyb_porter_mobile']     = '';
        }
