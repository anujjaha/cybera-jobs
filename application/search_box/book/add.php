...
<!-- general form elements disabled -->
	...
	<div class="box-body">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" name="book_title" id="book_title" placeholder="Book Title" value="Sample Book 2018">
		</div>
		...
		<div class="form-group">
			<label>Book Replaced ?</label>
			<select name="is_replace" id="is_replace" class="form-control" >
				<option value="0">No</option>
				<option value="1">Yes</option>
			</select>
		</div>
