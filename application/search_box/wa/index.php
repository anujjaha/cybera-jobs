...
<div class="box">
	...
	<tbody>
		...
		<tr id="wa_<?php echo $result['id'];?>">
			...
			<td><?php echo $result['process'] . ' ' . $result['procsss_time'];?></td>
			<td><?php echo $result['delivery_time'];?></td>
			<td><?php echo $result['pack_forward'];?></td>
			<td><?php echo $result['transport_by'] . ' ' . $result['transport_cost'];?></td>
			<td><?php echo $result['sub_total'];?></td>
			<td><?php echo $result['gst'];?></td>
			<td><?php echo $result['total'];?></td>
			<td><?php echo $result['pay_by'];?></td>
			<td><?php echo $result['payment'];?></td>
			<td><?php echo $result['job_notes'];?></td>
			<td><?php echo $result['extra_notes'];?></td>
