...
#define('PRINT_MUSIC','http://111.111.111.148/ncybera/printing-sound.mp3');
define('PRINT_MUSIC','http://111.111.111.148/ncybera/cutting.mp3');
define('CUTTING_MUSIC','http://111.111.111.148/ncybera/cutting.mp3');
...
define('DEALER_DISCOUNT', true);
define('SEND_DEALER_MAIL', true);
define('DEALER_DISCOUNT_PERCENTAGE', 0.10);
