...
<div class="col-md-12">
	...
	<div>
		<div class="col-md-1">
			<input type="text" class="form-control" id="paper_gram" name="paper_gram[]" required="required">
		</div>
		<div class="col-md-2">
		...
		<div class="col-md-1">
			<select class="form-control" id="paper_print" name="paper_print[]">
...
$(document).ready(function() {
    ...
    var paper_gram,paper_size,paper_name,paper_qty_min,paper_qty_max,paper_amount,paper_print;
    ...
    else
    {
        ...
        if(x < max_fields){ //max input box allowed
            ...
            $(wrapper).append('<div class="row"><hr><div class="col-md-1"><input type="text" name="paper_gram[]" class="form-control" value="'+paper_gram+'"></div><div class="col-md-2"><input type="text" name="paper_size[]" value="'+paper_size+'"></div><div class="col-md-2"><input type="text" name="paper_name[]" value="'+paper_name+'"></div><div class="col-md-1"><select class="form-control" name="paper_print[]"><option '+fb+' value="1">SS</option><option  '+ss+'  value="2">FB</option></select></div><div class="col-md-2"><input type="text" name="paper_qty_min[]" value="'+paper_qty_min+'"></div><div class="col-md-2"><input type="text" name="paper_qty_max[]" value="'+paper_qty_max+'"></div><div class="col-md-1"><input type="text" name="paper_amount[]" value="'+paper_amount+'" style="width:50px;"></div><a href="#" class="glyphicon glyphicon-minus-sign remove_field"></a></div>'); //add input box
        }
    });
