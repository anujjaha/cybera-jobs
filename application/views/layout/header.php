...
function copyCNotesNow()
{
	...
	if($("#cjprocessm").val().length > 0 )
	{
		cjprocess = '\n *- PROCESS: ' + $("#cjprocessm").val() + ' WORKING '+ cjprocessType + cjprocessTime +'*';
	}	
	else if($("#cjprocess").val() != '0' )
	{
		cjprocessType = $("#cjprocessType").val();
		cjprocess = '\n *- PROCESS: ' + $("#cjprocess").val() + ' WORKING '+ cjprocessType + cjprocessTime +'*';
	}
			...
			<div class="col-md-12">
				...
				<div class="col-md-6">
					<div class="row form-group">
						<div class="col-md-6">
							<label>Process ( working days ):</label>
							<div class="p0 col-md-12" style="padding:0px;">
								<div class="row col-md-6">
				  				...
				  				<div class="col-md-6">
				  					<input class="form-control" name="cjprocessm" id="cjprocessm" value="" placeholder="Manually">
				  				</div>
			  				</div>
						</div>
						<div class="col-md-3">
