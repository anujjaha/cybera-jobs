...
<script src="<?php echo base_url('assets/js/plugins/datatables/advance-data-table.js');?>" type="text/javascript"></script>
...
<script type="text/javascript">
			...
			$('#example1').DataTable( {
				"processing": true,
				"serverSide": true,
				"ajax": "<?php echo site_url();?>/account/index_ajax_data"
			} );
