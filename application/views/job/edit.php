...
function mandatoryTransporter(data)
{
	var city = data.city.toLocaleLowerCase();
	if(data.dealercode != '' && city != 'ahmedabad')
	{
		$("#transporter_id").attr('required', 'required');
		return;
	}
