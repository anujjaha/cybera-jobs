...
<tr>
	...
	<tr>
		...
		<td>
			<input type="text" id="c_material_<?php echo $sr;?>" name="c_material_<?php echo $sr;?>" value="<?php echo $cutting['c_material'];?>">
		</td>
	</tr>
	<tr>
		<td>Quantity</td>
		...
		<td>
			<input type="text" id="c_qty_<?php echo $sr;?>" name="c_qty_<?php echo $sr;?>" value="<?php echo $cutting['c_qty'];?>">
		</td>
	</tr>
	<tr>
		<td>Printing</td>
...
function updateCuttingDetails(element)
{
    ...
    var machine 		= jQuery('input:radio[name=c_machine_'+dataId+']:checked').val(),
    	...
    	materialInfo 	= jQuery("#c_material_"+dataId).val(),
    	cardQty 		= jQuery("#c_qty_"+dataId).val(),
