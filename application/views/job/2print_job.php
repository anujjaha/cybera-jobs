...
foreach($cutting_info as $cutting) {
	$pcontent .= '<div style="height:8.3in; width:5.8in; font-size:8px; font-family:Arial, Helvetica, sans-serif;">';
...
$pcontent .='<table align="center" border="2" width="90%" style="border:1px solid;"><tr>';
	$pcontent .= '<td>
				<table align="center" border="2" width="90%" style="border:1px solid;">';
