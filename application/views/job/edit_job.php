...
<script>
    ...
    {
    	<?php
    		if(isset($job_data->cyb_porter)  && $job_data->cyb_porter == 1 )
    		{
    		?>
		    	// Default Port Hide
				$(".showPorter").show();
		...
		<td colspan="2" align="center">
			<table border="2" class="table">
				...
				<tr style="height: 70px;">
					<td>
						<label>
							<input  <?php if($job_data->cyb_porter == 1) echo 'checked="checked"';?>  type="checkbox" name="cyb_porter"  id="cyb_porter" value="1">
							Porter
						</label>
					</td>
					<td colspan="2">
						<div class="showPorter">
							...
							<textarea name="cyb_porter_details" id="cyb_porter_details"  class="form-control"><?=$job_data->cyb_porter_details?></textarea>
						</div>
					</td>
					<td  colspan="2">
						<div class="showPorter">
							...
							<input type="text" name="cyb_porter_mobile" id="cyb_porter_mobile"  class="form-control" value="<?=$job_data->cyb_porter_mobile?>">
						</div>
					</td>
					<td>
						<div class="showPorter">
							...
							<select name="cyb_porter_pay" id="cyb_porter_pay"  class="form-control" >
								<option <?= isset($job_data->cyb_porter_pay) && $job_data->cyb_porter_pay == 'Self' ? "selected='selected'" : "";?>>Self</option>
								<option <?= isset($job_data->cyb_porter_pay) && $job_data->cyb_porter_pay == 'Party' ? "selected='selected'" : "";?>>Party</option>
							</select>
						</div>
					</td>
				</tr>
...
function bindPorterEvent()
{
	$("#cyb_porter").on('ifChanged', function(event)
	{
